/*=============================================================================
  ...
  Creates database, schema, warehouse, and loads sample incident data.
=============================================================================*/
...
/*-----------------------------------------------------------------------------
TABLE 5: INCIDENT_FACT
Stores one record per incident along with measurable operational values such as resolution time, 
downtime, and customers affected.

Each incident belongs to one application with a priority and a status, which is then assigned to an owner to resolve.
-----------------------------------------------------------------------------*/
